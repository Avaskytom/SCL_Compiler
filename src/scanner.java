...
public class scanner {
    ...
    private void processLine(String line, int lineNum, int index) {
        ...
        while (index < line.length()) {
            ...
            System.out.println(lexType + ", " + "symbol: " + lexeme + " " +
                    "line: " + lineNum + " col: " + index);
    ...
    private LexemeType getLexemeType(String lexeme, int lineNum, int colNum) {
        ...
        if (lexeme.charAt(0) == '"' && (lexeme.charAt(lexeme.length() - 1) == '"' || lexeme.charAt(lexeme.length() - 2) == '"')) {
        ...
        } else if (Character.isDigit(lexeme.charAt(0)) && Character.isDigit(lexeme.charAt(lexeme.length() - 1))) {
            ...
            } else if (lexeme.substring(0, Math.min(lexeme.length(), 2)).equals("//")) {
